...
|--------|---------|-------------|
| [RPI](./rpi/) | 0.6.0 | Research-Planning-Implementation strategy for disciplined software development |
| [Product Team](./product-team/) | 0.7.0 | Agile product team simulation plugin with specialized agents for different roles and commands for common team activities |
...
| [Utils](./utils/) | 0.2.0 | Utility agents for system maintenance and troubleshooting |
